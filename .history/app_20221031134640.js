...
shuffle.addEventListener('click', ()=>{
    ...
    switch (a) {
        case "next":
            shuffle.classList.add('fa-solid fa-repeat')
            shuffle.classList.remove('fa fa-music')
            shuffle.classList.remove('fa-shuffle')
            shuffle.innerHTML = 'repeat'
            break;
    
        case "repeat":
        shuffle.classList.remove('fa-solid fa-repeat')
            shuffle.classList.remove('fa fa-music')
            shuffle.classList.add('fa-shuffle')
            shuffle.innerHTML = 'random'
            break;
        case "random":
        shuffle.classList.remove('fa fa-repeat')
            shuffle.classList.add('fa fa-music')
            shuffle.classList.remove('fa-shuffle')
