...
vol.addEventListener('change', ()=>{
    if(vol.value == 0){
        vol_icon.classList.remove('fa fa-volume-up')
        vol_icon.classList.remove('fa fa-volume-down')
        vol_icon.classList.add('fa fa-volume-off')
    }
    if(vol.value > 0){
        vol_icon.classList.remove('fa fa-volume-up')
        vol_icon.classList.add('fa fa-volume-down')
        vol_icon.classList.remove('fa fa-volume-off')
    }
    if(vol.value > 50){
        vol_icon.classList.add('fa fa-volume-up')
        vol_icon.classList.add('fa fa-volume-down')
        vol_icon.classList.remove('fa fa-volume-off')
    }
})
